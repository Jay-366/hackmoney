...
export function AgentCard({ agent, onToggleLike, isLiked }: AgentCardProps) {
    ...
    return (
        <article className="group glass-panel rounded-[2rem] p-6 transition-all duration-500 hover:bg-white/[0.05] border border-white/[0.04] h-[220px] flex flex-col justify-between">
